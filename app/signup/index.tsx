        ...
        <VStack>
          ...
          <Box className="gap-2">
            ...
            <Box>
              ...
              <Text color={"$accent10"} marginBlockStart={2}>A confirmation message will be sent on your phone</Text>
            </Box>
            <Box>
          ...
          <Button className="my-4" marginBlock={16} onPress={() => router.navigate("/user")} theme="black">
            Signup
          </Button>
        </VStack>
      </ScrollView>
